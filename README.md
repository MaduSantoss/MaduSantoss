...
Desenvolvedora de software com foco em criar aplicações completas, unindo boas práticas de frontend e backend.

- 🗺️  Moro em Aracaju/SE, Brasil.
- 💼  Atualmente estagiária em Desenvolvimento na **Prefeitura de Aracaju** e fui Suporte Técnico na **Climedi**.
- 📚  Cursando Análise e Desenvolvimento de Sistemas na Uninassau (Previsão: 2026).
- 🎯  Meu foco atual é o desenvolvimento web,além de manter estudos no **Back-End**.
...
<div style="display:inline_block">
    ...
    <img align="center" alt="StyledComponents" height="30" width="140" src="https://img.shields.io/badge/styled--components-DB7093?style=for-the-badge&logo=styled-components&logoColor=white">
</div>
